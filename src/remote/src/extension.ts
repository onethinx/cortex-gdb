...
export class CortexDebugRemote {
    ...
    constructor(public context: vscode.ExtensionContext) {
        ...
        vscode.window.showInformationMessage('cortex-gdb-remote activated!');
        const disposable = vscode.commands.registerCommand('cortex-gdb-remote.helloWorld', this.hello.bind(this));
    ...
    public hello(arg: string): Interfaces.helloReturn {
        const str = `in Hello() from cortex-gdb-remote! arg: ${arg}`;
